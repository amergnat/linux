...
static const struct clk_parent_data gxbb_32k_clk_parent_data[] = {
	{ .fw_name = "xtal", },
	/* FIXME: Clock name provided by another file */
...
static MESON_GATE(gxbb_ddr, HHI_GCLK_MPEG0, 0, gxbb_clk81);
static MESON_GATE(gxbb_dos, HHI_GCLK_MPEG0, 1, gxbb_clk81);
static MESON_GATE(gxbb_isa, HHI_GCLK_MPEG0, 5, gxbb_clk81);
static MESON_GATE(gxbb_pl301, HHI_GCLK_MPEG0, 6, gxbb_clk81);
static MESON_GATE(gxbb_periphs, HHI_GCLK_MPEG0, 7, gxbb_clk81);
static MESON_GATE(gxbb_spicc, HHI_GCLK_MPEG0, 8, gxbb_clk81);
static MESON_GATE(gxbb_i2c, HHI_GCLK_MPEG0, 9, gxbb_clk81);
static MESON_GATE(gxbb_sana, HHI_GCLK_MPEG0, 10, gxbb_clk81);
static MESON_GATE(gxbb_smart_card, HHI_GCLK_MPEG0, 11, gxbb_clk81);
static MESON_GATE(gxbb_rng0, HHI_GCLK_MPEG0, 12, gxbb_clk81);
static MESON_GATE(gxbb_uart0, HHI_GCLK_MPEG0, 13, gxbb_clk81);
static MESON_GATE(gxbb_sdhc, HHI_GCLK_MPEG0, 14, gxbb_clk81);
static MESON_GATE(gxbb_stream, HHI_GCLK_MPEG0, 15, gxbb_clk81);
static MESON_GATE(gxbb_async_fifo, HHI_GCLK_MPEG0, 16, gxbb_clk81);
static MESON_GATE(gxbb_sdio, HHI_GCLK_MPEG0, 17, gxbb_clk81);
static MESON_GATE(gxbb_abuf, HHI_GCLK_MPEG0, 18, gxbb_clk81);
static MESON_GATE(gxbb_hiu_iface, HHI_GCLK_MPEG0, 19, gxbb_clk81);
static MESON_GATE(gxbb_assist_misc, HHI_GCLK_MPEG0, 23, gxbb_clk81);
static MESON_GATE(gxbb_emmc_a, HHI_GCLK_MPEG0, 24, gxbb_clk81);
static MESON_GATE(gxbb_emmc_b, HHI_GCLK_MPEG0, 25, gxbb_clk81);
static MESON_GATE(gxbb_emmc_c, HHI_GCLK_MPEG0, 26, gxbb_clk81);
static MESON_GATE(gxbb_spi, HHI_GCLK_MPEG0, 30, gxbb_clk81);

static MESON_GATE(gxbb_i2s_spdif, HHI_GCLK_MPEG1, 2, gxbb_clk81);
static MESON_GATE(gxbb_eth, HHI_GCLK_MPEG1, 3, gxbb_clk81);
static MESON_GATE(gxbb_demux, HHI_GCLK_MPEG1, 4, gxbb_clk81);
static MESON_GATE(gxbb_aiu_glue, HHI_GCLK_MPEG1, 6, gxbb_clk81);
static MESON_GATE(gxbb_iec958, HHI_GCLK_MPEG1, 7, gxbb_clk81);
static MESON_GATE(gxbb_i2s_out, HHI_GCLK_MPEG1, 8, gxbb_clk81);
static MESON_GATE(gxbb_amclk, HHI_GCLK_MPEG1, 9, gxbb_clk81);
static MESON_GATE(gxbb_aififo2, HHI_GCLK_MPEG1, 10, gxbb_clk81);
static MESON_GATE(gxbb_mixer, HHI_GCLK_MPEG1, 11, gxbb_clk81);
static MESON_GATE(gxbb_mixer_iface, HHI_GCLK_MPEG1, 12, gxbb_clk81);
static MESON_GATE(gxbb_adc, HHI_GCLK_MPEG1, 13, gxbb_clk81);
static MESON_GATE(gxbb_blkmv, HHI_GCLK_MPEG1, 14, gxbb_clk81);
static MESON_GATE(gxbb_aiu, HHI_GCLK_MPEG1, 15, gxbb_clk81);
static MESON_GATE(gxbb_uart1, HHI_GCLK_MPEG1, 16, gxbb_clk81);
static MESON_GATE(gxbb_g2d, HHI_GCLK_MPEG1, 20, gxbb_clk81);
static MESON_GATE(gxbb_usb0, HHI_GCLK_MPEG1, 21, gxbb_clk81);
static MESON_GATE(gxbb_usb1, HHI_GCLK_MPEG1, 22, gxbb_clk81);
static MESON_GATE(gxbb_reset, HHI_GCLK_MPEG1, 23, gxbb_clk81);
static MESON_GATE(gxbb_nand, HHI_GCLK_MPEG1, 24, gxbb_clk81);
static MESON_GATE(gxbb_dos_parser, HHI_GCLK_MPEG1, 25, gxbb_clk81);
static MESON_GATE(gxbb_usb, HHI_GCLK_MPEG1, 26, gxbb_clk81);
static MESON_GATE(gxbb_vdin1, HHI_GCLK_MPEG1, 28, gxbb_clk81);
static MESON_GATE(gxbb_ahb_arb0, HHI_GCLK_MPEG1, 29, gxbb_clk81);
static MESON_GATE(gxbb_efuse, HHI_GCLK_MPEG1, 30, gxbb_clk81);
static MESON_GATE(gxbb_boot_rom, HHI_GCLK_MPEG1, 31, gxbb_clk81);

static MESON_GATE(gxbb_ahb_data_bus, HHI_GCLK_MPEG2, 1, gxbb_clk81);
static MESON_GATE(gxbb_ahb_ctrl_bus, HHI_GCLK_MPEG2, 2, gxbb_clk81);
static MESON_GATE(gxbb_hdmi_intr_sync, HHI_GCLK_MPEG2, 3, gxbb_clk81);
static MESON_GATE(gxbb_hdmi_pclk, HHI_GCLK_MPEG2, 4, gxbb_clk81);
static MESON_GATE(gxbb_usb1_ddr_bridge, HHI_GCLK_MPEG2, 8, gxbb_clk81);
static MESON_GATE(gxbb_usb0_ddr_bridge, HHI_GCLK_MPEG2, 9, gxbb_clk81);
static MESON_GATE(gxbb_mmc_pclk, HHI_GCLK_MPEG2, 11, gxbb_clk81);
static MESON_GATE(gxbb_dvin, HHI_GCLK_MPEG2, 12, gxbb_clk81);
static MESON_GATE(gxbb_uart2, HHI_GCLK_MPEG2, 15, gxbb_clk81);
static MESON_GATE(gxbb_sar_adc, HHI_GCLK_MPEG2, 22, gxbb_clk81);
static MESON_GATE(gxbb_vpu_intr, HHI_GCLK_MPEG2, 25, gxbb_clk81);
static MESON_GATE(gxbb_sec_ahb_ahb3_bridge, HHI_GCLK_MPEG2, 26, gxbb_clk81);
static MESON_GATE(gxbb_clk81_a53, HHI_GCLK_MPEG2, 29, gxbb_clk81);

static MESON_GATE(gxbb_vclk2_venci0, HHI_GCLK_OTHER, 1, gxbb_clk81);
static MESON_GATE(gxbb_vclk2_venci1, HHI_GCLK_OTHER, 2, gxbb_clk81);
static MESON_GATE(gxbb_vclk2_vencp0, HHI_GCLK_OTHER, 3, gxbb_clk81);
static MESON_GATE(gxbb_vclk2_vencp1, HHI_GCLK_OTHER, 4, gxbb_clk81);
static MESON_GATE(gxbb_gclk_venci_int0, HHI_GCLK_OTHER, 8, gxbb_clk81);
static MESON_GATE(gxbb_gclk_vencp_int, HHI_GCLK_OTHER, 9, gxbb_clk81);
static MESON_GATE(gxbb_dac_clk, HHI_GCLK_OTHER, 10, gxbb_clk81);
static MESON_GATE(gxbb_aoclk_gate, HHI_GCLK_OTHER, 14, gxbb_clk81);
static MESON_GATE(gxbb_iec958_gate, HHI_GCLK_OTHER, 16, gxbb_clk81);
static MESON_GATE(gxbb_enc480p, HHI_GCLK_OTHER, 20, gxbb_clk81);
static MESON_GATE(gxbb_rng1, HHI_GCLK_OTHER, 21, gxbb_clk81);
static MESON_GATE(gxbb_gclk_venci_int1, HHI_GCLK_OTHER, 22, gxbb_clk81);
static MESON_GATE(gxbb_vclk2_venclmcc, HHI_GCLK_OTHER, 24, gxbb_clk81);
static MESON_GATE(gxbb_vclk2_vencl, HHI_GCLK_OTHER, 25, gxbb_clk81);
static MESON_GATE(gxbb_vclk_other, HHI_GCLK_OTHER, 26, gxbb_clk81);
static MESON_GATE(gxbb_edp, HHI_GCLK_OTHER, 31, gxbb_clk81);

/* Always On (AO) domain gates */

static MESON_GATE(gxbb_ao_media_cpu, HHI_GCLK_AO, 0, gxbb_clk81);
static MESON_GATE(gxbb_ao_ahb_sram, HHI_GCLK_AO, 1, gxbb_clk81);
static MESON_GATE(gxbb_ao_ahb_bus, HHI_GCLK_AO, 2, gxbb_clk81);
static MESON_GATE(gxbb_ao_iface, HHI_GCLK_AO, 3, gxbb_clk81);
static MESON_GATE(gxbb_ao_i2c, HHI_GCLK_AO, 4, gxbb_clk81);
