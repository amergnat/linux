...
static MESON_GATE(g12a_ddr,			HHI_GCLK_MPEG0,	0, g12a_clk81);
static MESON_GATE(g12a_dos,			HHI_GCLK_MPEG0,	1, g12a_clk81);
static MESON_GATE(g12a_audio_locker,		HHI_GCLK_MPEG0,	2, g12a_clk81);
static MESON_GATE(g12a_mipi_dsi_host,		HHI_GCLK_MPEG0,	3, g12a_clk81);
static MESON_GATE(g12a_eth_phy,			HHI_GCLK_MPEG0,	4, g12a_clk81);
static MESON_GATE(g12a_isa,			HHI_GCLK_MPEG0,	5, g12a_clk81);
static MESON_GATE(g12a_pl301,			HHI_GCLK_MPEG0,	6, g12a_clk81);
static MESON_GATE(g12a_periphs,			HHI_GCLK_MPEG0,	7, g12a_clk81);
static MESON_GATE(g12a_spicc_0,			HHI_GCLK_MPEG0,	8, g12a_clk81);
static MESON_GATE(g12a_i2c,			HHI_GCLK_MPEG0,	9, g12a_clk81);
static MESON_GATE(g12a_sana,			HHI_GCLK_MPEG0,	10, g12a_clk81);
static MESON_GATE(g12a_sd,			HHI_GCLK_MPEG0,	11, g12a_clk81);
static MESON_GATE(g12a_rng0,			HHI_GCLK_MPEG0,	12, g12a_clk81);
static MESON_GATE(g12a_uart0,			HHI_GCLK_MPEG0,	13, g12a_clk81);
static MESON_GATE(g12a_spicc_1,			HHI_GCLK_MPEG0,	14, g12a_clk81);
static MESON_GATE(g12a_hiu_reg,			HHI_GCLK_MPEG0,	19, g12a_clk81);
static MESON_GATE(g12a_mipi_dsi_phy,		HHI_GCLK_MPEG0,	20, g12a_clk81);
static MESON_GATE(g12a_assist_misc,		HHI_GCLK_MPEG0,	23, g12a_clk81);
static MESON_GATE(g12a_emmc_a,			HHI_GCLK_MPEG0,	4, g12a_clk81);
static MESON_GATE(g12a_emmc_b,			HHI_GCLK_MPEG0,	25, g12a_clk81);
static MESON_GATE(g12a_emmc_c,			HHI_GCLK_MPEG0,	26, g12a_clk81);
static MESON_GATE(g12a_audio_codec,		HHI_GCLK_MPEG0,	28, g12a_clk81);

static MESON_GATE(g12a_audio,			HHI_GCLK_MPEG1,	0, g12a_clk81);
static MESON_GATE(g12a_eth_core,		HHI_GCLK_MPEG1,	3, g12a_clk81);
static MESON_GATE(g12a_demux,			HHI_GCLK_MPEG1,	4, g12a_clk81);
static MESON_GATE(g12a_audio_ififo,		HHI_GCLK_MPEG1,	11, g12a_clk81);
static MESON_GATE(g12a_adc,			HHI_GCLK_MPEG1,	13, g12a_clk81);
static MESON_GATE(g12a_uart1,			HHI_GCLK_MPEG1,	16, g12a_clk81);
static MESON_GATE(g12a_g2d,			HHI_GCLK_MPEG1,	20, g12a_clk81);
static MESON_GATE(g12a_reset,			HHI_GCLK_MPEG1,	23, g12a_clk81);
static MESON_GATE(g12a_pcie_comb,		HHI_GCLK_MPEG1,	24, g12a_clk81);
static MESON_GATE(g12a_parser,			HHI_GCLK_MPEG1,	25, g12a_clk81);
static MESON_GATE(g12a_usb_general,		HHI_GCLK_MPEG1,	26, g12a_clk81);
static MESON_GATE(g12a_pcie_phy,		HHI_GCLK_MPEG1,	27, g12a_clk81);
static MESON_GATE(g12a_ahb_arb0,		HHI_GCLK_MPEG1,	29, g12a_clk81);

static MESON_GATE(g12a_ahb_data_bus,		HHI_GCLK_MPEG2,	1, g12a_clk81);
static MESON_GATE(g12a_ahb_ctrl_bus,		HHI_GCLK_MPEG2,	2, g12a_clk81);
static MESON_GATE(g12a_htx_hdcp22,		HHI_GCLK_MPEG2,	3, g12a_clk81);
static MESON_GATE(g12a_htx_pclk,		HHI_GCLK_MPEG2,	4, g12a_clk81);
static MESON_GATE(g12a_bt656,			HHI_GCLK_MPEG2,	6, g12a_clk81);
static MESON_GATE(g12a_usb1_to_ddr,		HHI_GCLK_MPEG2,	8, g12a_clk81);
static MESON_GATE(g12a_mmc_pclk,		HHI_GCLK_MPEG2,	11, g12a_clk81);
static MESON_GATE(g12a_uart2,			HHI_GCLK_MPEG2,	15, g12a_clk81);
static MESON_GATE(g12a_vpu_intr,		HHI_GCLK_MPEG2,	25, g12a_clk81);
static MESON_GATE(g12a_gic,			HHI_GCLK_MPEG2,	30, g12a_clk81);

static MESON_GATE(g12a_vclk2_venci0,		HHI_GCLK_OTHER,	1, g12a_clk81);
static MESON_GATE(g12a_vclk2_venci1,		HHI_GCLK_OTHER,	2, g12a_clk81);
static MESON_GATE(g12a_vclk2_vencp0,		HHI_GCLK_OTHER,	3, g12a_clk81);
static MESON_GATE(g12a_vclk2_vencp1,		HHI_GCLK_OTHER,	4, g12a_clk81);
static MESON_GATE(g12a_vclk2_venct0,		HHI_GCLK_OTHER,	5, g12a_clk81);
static MESON_GATE(g12a_vclk2_venct1,		HHI_GCLK_OTHER,	6, g12a_clk81);
static MESON_GATE(g12a_vclk2_other,		HHI_GCLK_OTHER,	7, g12a_clk81);
static MESON_GATE(g12a_vclk2_enci,		HHI_GCLK_OTHER,	8, g12a_clk81);
static MESON_GATE(g12a_vclk2_encp,		HHI_GCLK_OTHER,	9, g12a_clk81);
static MESON_GATE(g12a_dac_clk,			HHI_GCLK_OTHER,	10, g12a_clk81);
static MESON_GATE(g12a_aoclk_gate,		HHI_GCLK_OTHER,	14, g12a_clk81);
static MESON_GATE(g12a_iec958_gate,		HHI_GCLK_OTHER,	16, g12a_clk81);
static MESON_GATE(g12a_enc480p,			HHI_GCLK_OTHER,	20, g12a_clk81);
static MESON_GATE(g12a_rng1,			HHI_GCLK_OTHER,	21, g12a_clk81);
static MESON_GATE(g12a_vclk2_enct,		HHI_GCLK_OTHER,	22, g12a_clk81);
static MESON_GATE(g12a_vclk2_encl,		HHI_GCLK_OTHER,	23, g12a_clk81);
static MESON_GATE(g12a_vclk2_venclmmc,		HHI_GCLK_OTHER,	24, g12a_clk81);
static MESON_GATE(g12a_vclk2_vencl,		HHI_GCLK_OTHER,	25, g12a_clk81);
static MESON_GATE(g12a_vclk2_other1,		HHI_GCLK_OTHER,	26, g12a_clk81);

static MESON_GATE_RO(g12a_dma,			HHI_GCLK_OTHER2, 0, g12a_clk81);
static MESON_GATE_RO(g12a_efuse,		HHI_GCLK_OTHER2, 1, g12a_clk81);
static MESON_GATE_RO(g12a_rom_boot,		HHI_GCLK_OTHER2, 2, g12a_clk81);
static MESON_GATE_RO(g12a_reset_sec,		HHI_GCLK_OTHER2, 3, g12a_clk81);
static MESON_GATE_RO(g12a_sec_ahb_apb3,		HHI_GCLK_OTHER2, 4, g12a_clk81);
