...
#define __MESON_GATE(_name, _reg, _bit, _ops, _pname)			\
...
#define MESON_GATE(_name, _reg, _bit, _pname)	\
	__MESON_GATE(_name, _reg, _bit, &clk_regmap_gate_ops, _pname)

#define MESON_GATE_RO(_name, _reg, _bit, _pname)	\
	__MESON_GATE(_name, _reg, _bit, &clk_regmap_gate_ro_ops, _pname)
