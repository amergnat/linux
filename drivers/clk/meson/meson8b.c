...
static const struct clk_hw *mmeson8b_vpu_0_1_parent_hws[] = {
	&meson8b_fclk_div4.hw,
	&meson8b_fclk_div3.hw,
	&meson8b_fclk_div5.hw,
	&meson8b_fclk_div7.hw,
...
static struct clk_regmap meson8b_vpu_0_sel = {
	...
	.hw.init = &(struct clk_init_data){
		.name = "vpu_0_sel",
		.ops = &clk_regmap_mux_ops,
		.parent_hws = mmeson8b_vpu_0_1_parent_hws,
		.num_parents = ARRAY_SIZE(mmeson8b_vpu_0_1_parent_hws),
		.flags = CLK_SET_RATE_PARENT,
	},
};
...
static MESON_GATE(meson8b_ddr, HHI_GCLK_MPEG0, 0, meson8b_clk81);
static MESON_GATE(meson8b_dos, HHI_GCLK_MPEG0, 1, meson8b_clk81);
static MESON_GATE(meson8b_isa, HHI_GCLK_MPEG0, 5, meson8b_clk81);
static MESON_GATE(meson8b_pl301, HHI_GCLK_MPEG0, 6, meson8b_clk81);
static MESON_GATE(meson8b_periphs, HHI_GCLK_MPEG0, 7, meson8b_clk81);
static MESON_GATE(meson8b_spicc, HHI_GCLK_MPEG0, 8, meson8b_clk81);
static MESON_GATE(meson8b_i2c, HHI_GCLK_MPEG0, 9, meson8b_clk81);
static MESON_GATE(meson8b_sar_adc, HHI_GCLK_MPEG0, 10, meson8b_clk81);
static MESON_GATE(meson8b_smart_card, HHI_GCLK_MPEG0, 11, meson8b_clk81);
static MESON_GATE(meson8b_rng0, HHI_GCLK_MPEG0, 12, meson8b_clk81);
static MESON_GATE(meson8b_uart0, HHI_GCLK_MPEG0, 13, meson8b_clk81);
static MESON_GATE(meson8b_sdhc, HHI_GCLK_MPEG0, 14, meson8b_clk81);
static MESON_GATE(meson8b_stream, HHI_GCLK_MPEG0, 15, meson8b_clk81);
static MESON_GATE(meson8b_async_fifo, HHI_GCLK_MPEG0, 16, meson8b_clk81);
static MESON_GATE(meson8b_sdio, HHI_GCLK_MPEG0, 17, meson8b_clk81);
static MESON_GATE(meson8b_abuf, HHI_GCLK_MPEG0, 18, meson8b_clk81);
static MESON_GATE(meson8b_hiu_iface, HHI_GCLK_MPEG0, 19, meson8b_clk81);
static MESON_GATE(meson8b_assist_misc, HHI_GCLK_MPEG0, 23, meson8b_clk81);
static MESON_GATE(meson8b_spi, HHI_GCLK_MPEG0, 30, meson8b_clk81);

static MESON_GATE(meson8b_i2s_spdif, HHI_GCLK_MPEG1, 2, meson8b_clk81);
static MESON_GATE(meson8b_eth, HHI_GCLK_MPEG1, 3, meson8b_clk81);
static MESON_GATE(meson8b_demux, HHI_GCLK_MPEG1, 4, meson8b_clk81);
static MESON_GATE(meson8b_aiu_glue, HHI_GCLK_MPEG1, 6, meson8b_clk81);
static MESON_GATE(meson8b_iec958, HHI_GCLK_MPEG1, 7, meson8b_clk81);
static MESON_GATE(meson8b_i2s_out, HHI_GCLK_MPEG1, 8, meson8b_clk81);
static MESON_GATE(meson8b_amclk, HHI_GCLK_MPEG1, 9, meson8b_clk81);
static MESON_GATE(meson8b_aififo2, HHI_GCLK_MPEG1, 10, meson8b_clk81);
static MESON_GATE(meson8b_mixer, HHI_GCLK_MPEG1, 11, meson8b_clk81);
static MESON_GATE(meson8b_mixer_iface, HHI_GCLK_MPEG1, 12, meson8b_clk81);
static MESON_GATE(meson8b_adc, HHI_GCLK_MPEG1, 13, meson8b_clk81);
static MESON_GATE(meson8b_blkmv, HHI_GCLK_MPEG1, 14, meson8b_clk81);
static MESON_GATE(meson8b_aiu, HHI_GCLK_MPEG1, 15, meson8b_clk81);
static MESON_GATE(meson8b_uart1, HHI_GCLK_MPEG1, 16, meson8b_clk81);
static MESON_GATE(meson8b_g2d, HHI_GCLK_MPEG1, 20, meson8b_clk81);
static MESON_GATE(meson8b_usb0, HHI_GCLK_MPEG1, 21, meson8b_clk81);
static MESON_GATE(meson8b_usb1, HHI_GCLK_MPEG1, 22, meson8b_clk81);
static MESON_GATE(meson8b_reset, HHI_GCLK_MPEG1, 23, meson8b_clk81);
static MESON_GATE(meson8b_nand, HHI_GCLK_MPEG1, 24, meson8b_clk81);
static MESON_GATE(meson8b_dos_parser, HHI_GCLK_MPEG1, 25, meson8b_clk81);
static MESON_GATE(meson8b_usb, HHI_GCLK_MPEG1, 26, meson8b_clk81);
static MESON_GATE(meson8b_vdin1, HHI_GCLK_MPEG1, 28, meson8b_clk81);
static MESON_GATE(meson8b_ahb_arb0, HHI_GCLK_MPEG1, 29, meson8b_clk81);
static MESON_GATE(meson8b_efuse, HHI_GCLK_MPEG1, 30, meson8b_clk81);
static MESON_GATE(meson8b_boot_rom, HHI_GCLK_MPEG1, 31, meson8b_clk81);

static MESON_GATE(meson8b_ahb_data_bus, HHI_GCLK_MPEG2, 1, meson8b_clk81);
static MESON_GATE(meson8b_ahb_ctrl_bus, HHI_GCLK_MPEG2, 2, meson8b_clk81);
static MESON_GATE(meson8b_hdmi_intr_sync, HHI_GCLK_MPEG2, 3, meson8b_clk81);
static MESON_GATE(meson8b_hdmi_pclk, HHI_GCLK_MPEG2, 4, meson8b_clk81);
static MESON_GATE(meson8b_usb1_ddr_bridge, HHI_GCLK_MPEG2, 8, meson8b_clk81);
static MESON_GATE(meson8b_usb0_ddr_bridge, HHI_GCLK_MPEG2, 9, meson8b_clk81);
static MESON_GATE(meson8b_mmc_pclk, HHI_GCLK_MPEG2, 11, meson8b_clk81);
static MESON_GATE(meson8b_dvin, HHI_GCLK_MPEG2, 12, meson8b_clk81);
static MESON_GATE(meson8b_uart2, HHI_GCLK_MPEG2, 15, meson8b_clk81);
static MESON_GATE(meson8b_sana, HHI_GCLK_MPEG2, 22, meson8b_clk81);
static MESON_GATE(meson8b_vpu_intr, HHI_GCLK_MPEG2, 25, meson8b_clk81);
static MESON_GATE(meson8b_sec_ahb_ahb3_bridge, HHI_GCLK_MPEG2, 26, meson8b_clk81);
static MESON_GATE(meson8b_clk81_a9, HHI_GCLK_MPEG2, 29, meson8b_clk81);

static MESON_GATE(meson8b_vclk2_venci0, HHI_GCLK_OTHER, 1, meson8b_clk81);
static MESON_GATE(meson8b_vclk2_venci1, HHI_GCLK_OTHER, 2, meson8b_clk81);
static MESON_GATE(meson8b_vclk2_vencp0, HHI_GCLK_OTHER, 3, meson8b_clk81);
static MESON_GATE(meson8b_vclk2_vencp1, HHI_GCLK_OTHER, 4, meson8b_clk81);
static MESON_GATE(meson8b_gclk_venci_int, HHI_GCLK_OTHER, 8, meson8b_clk81);
static MESON_GATE(meson8b_gclk_vencp_int, HHI_GCLK_OTHER, 9, meson8b_clk81);
static MESON_GATE(meson8b_dac_clk, HHI_GCLK_OTHER, 10, meson8b_clk81);
static MESON_GATE(meson8b_aoclk_gate, HHI_GCLK_OTHER, 14, meson8b_clk81);
static MESON_GATE(meson8b_iec958_gate, HHI_GCLK_OTHER, 16, meson8b_clk81);
static MESON_GATE(meson8b_enc480p, HHI_GCLK_OTHER, 20, meson8b_clk81);
static MESON_GATE(meson8b_rng1, HHI_GCLK_OTHER, 21, meson8b_clk81);
static MESON_GATE(meson8b_gclk_vencl_int, HHI_GCLK_OTHER, 22, meson8b_clk81);
static MESON_GATE(meson8b_vclk2_venclmcc, HHI_GCLK_OTHER, 24, meson8b_clk81);
static MESON_GATE(meson8b_vclk2_vencl, HHI_GCLK_OTHER, 25, meson8b_clk81);
static MESON_GATE(meson8b_vclk2_other, HHI_GCLK_OTHER, 26, meson8b_clk81);
static MESON_GATE(meson8b_edp, HHI_GCLK_OTHER, 31, meson8b_clk81);

/* Always On (AO) domain gates */

static MESON_GATE(meson8b_ao_media_cpu, HHI_GCLK_AO, 0, meson8b_clk81);
static MESON_GATE(meson8b_ao_ahb_sram, HHI_GCLK_AO, 1, meson8b_clk81);
static MESON_GATE(meson8b_ao_ahb_bus, HHI_GCLK_AO, 2, meson8b_clk81);
static MESON_GATE(meson8b_ao_iface, HHI_GCLK_AO, 3, meson8b_clk81);
